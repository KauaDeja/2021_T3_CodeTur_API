...
{
    class AlterarComentarioCommand : Notifiable, ICommand
    {
        public AlterarComentarioCommand(string texto, string sentimento, EnStatusComentario status, Guid idUsuario, Guid idPacote)
        {
            Texto = texto;
