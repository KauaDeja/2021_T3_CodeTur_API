...
{
    public class CriarComentárioCommand : Notifiable, ICommand
    {
        public CriarComentárioCommand(string texto, string sentimento, EnStatusComentario status, Guid idUsuario, Guid idPacote)
        {
            Texto = texto;
